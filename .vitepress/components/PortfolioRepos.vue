...
<template>
  <table>
    ...
    <tr>
      ...
      <td v-if="props.pypi"><a target="_blank" :href="'https://pypi.org/project/' + props.name"><img src="/img/pypi.svg" width="32"></a></td>
      <td v-if="props.npm"><a target="_blank" :href="'https://www.npmjs.com/package/' + props.name"><img src="/img/npm.svg" width="50"></a></td>
